...
//#define __DEBUG_UART_DRIVER__
#ifdef __DEBUG_UART_DRIVER__
#include "mt12864j_drv.h"
#endif
						   ...
						   UART_InitTypeDef* UART_InitStruct )
{
	...
	#ifdef __DEBUG_UART_DRIVER__
	mt12864j_PrintNum(2, 0, cpuclock, 0);	
	#endif
	...
	#ifdef __DEBUG_UART_DRIVER__
	mt12864j_PrintNum(3, 0, integerdivider, 0);
	mt12864j_PrintNum(4, 0, fractionaldivider, 0);
	#endif
